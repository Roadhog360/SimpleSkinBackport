...
public class ModelSlimArm extends ModelHatLayer {
    ...
    public void addBox(float p_78790_1_, float p_78790_2_, float p_78790_3_, int p_78790_4_, int p_78790_5_, int p_78790_6_, float p_78790_7_) {
        ...
        //For some reason on the right arm specifically, this box seemingly ignores every modification made to it, and is exactly the same as
        //the boxWide above. I have no idea why, and I'd prefer to use this class over manually swapping two separate instances...
